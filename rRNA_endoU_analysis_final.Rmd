---
title: "Analysis of rRNA to Detect EndoU Cleavage Sites from experiemnt 2"
author: "Rachel Ancar"
date: "11/25/2018"
output: 
  html_document:
...
First, it is clear that there is signfiicant non-specific cleavage of ribosomal RNA that has been captured in these libaries. There is robust cleavage in the mock samples of all analyzed rRNAs. Across all rRNAs and conditions, most cleavage is detected at 9 vs. 12 hpi. The exception to this observation is for rRNA cleavage from B6 cells infected with MHV ns2 mutant. In these cells, there is more clevage at 12 hpi, which may be a reflection of specific increased RNase L activation. The 5s and 5.8s rRNA signal does not follow these patterns observed in the 18s and 28 rRNA. The signal in general is much lower and there do not seem to be any speciifc changes in signal captured across cell type or infection. 

Speciifc cleavage can still be detected at the known RNase L cleavage site in 18s rRNA at nucleotide 542 and 771. At this site, there is very little cleavage in the mock samples, and clear induction of cleavage at this site in B6 cells infected with the nsp15 mutant relative to the other virus types. 
